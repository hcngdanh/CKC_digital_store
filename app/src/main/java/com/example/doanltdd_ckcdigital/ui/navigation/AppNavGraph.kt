package com.example.doanltdd_ckcdigital.ui.navigation
...
import com.example.doanltdd_ckcdigital.ui.admin.AdminOrderDetailScreen
import com.example.doanltdd_ckcdigital.services.RetrofitClient
import com.example.doanltdd_ckcdigital.ui.SplashScreen
import com.example.doanltdd_ckcdigital.ui.admin.AdminDashboardScreen
import com.example.doanltdd_ckcdigital.ui.admin.AdminOrderManagerScreen
import com.example.doanltdd_ckcdigital.ui.auth.LoginScreen
import com.example.doanltdd_ckcdigital.ui.auth.RegisterScreen
import com.example.doanltdd_ckcdigital.ui.order.*
import com.example.doanltdd_ckcdigital.ui.product.ProductDetailScreen
import com.example.doanltdd_ckcdigital.ui.product.ProductListScreen
import com.example.doanltdd_ckcdigital.ui.profile.*
import com.example.doanltdd_ckcdigital.ui.profile.addresses.AddAddressScreen
import com.example.doanltdd_ckcdigital.ui.profile.addresses.AddressListScreen
import com.example.doanltdd_ckcdigital.ui.profile.addresses.EditAddressScreen
    ...
    NavHost(navController = navController, startDestination = "splash") {
        ...
        composable("cart") {
            CartScreen(
                onBackClick = { navController.popBackStack() },
                onCheckoutClick = {
                    if (sessionManager.isLoggedIn()) navController.navigate("checkout?productId=-1")
                    else navController.navigate("login")
                }
            )
        }
        ...
        composable("order_success") {
            OrderSuccessScreen(
                ...
                onViewOrderHistory = {
                    navController.navigate("order_history") { popUpTo("product_list") { inclusive = false } }
                }
            )
        }
        ...
        composable(
            ...
            val initialTab = try { HistoryStatus.valueOf(statusString) } catch (e: Exception) { HistoryStatus.ALL }
            val user = sessionManager.currentUser
        ...
        composable("profile") {
            ...
            if (user != null) {
                ProfileScreen(
                    ...
                    onOrderHistoryClick = { status -> navController.navigate("order_history?status=$status") },
        ...
        composable("admin_order_manager") {
            AdminOrderManagerScreen(
                onBackClick = { navController.popBackStack() },
                onOrderClick = { orderId -> navController.navigate("admin_order_detail/$orderId") }
            )
        }
